...
export default [
  ...
  { name: "Blog", path: "/article", component: Blog,meta:{title:"博客"} },
  { name: "CategoryBlog", path: "/article/cate/:categoryId", component: Blog,meta:{title:"博客"} },
  { name: "BlogDetail", path: "/article/:id", component: BlogDetail,meta:{title:"博客"} },
